...
$num_row = mysqli_num_rows($search_qry);
		...
		$sql= mysqli_query($conn,"INSERT INTO student_year_info
			 (STUDENT_ID, SCHOOL, YEAR, SECTION, TOTAL_NO_OF_YEAR, SCHOOL_YEAR, PRINCIPAL, ADVANCE_UNIT, LACK_UNIT, ADVISER,  RANK, TO_BE_CLASSIFIED, TDAYS_OF_CLASSES, TDAYS_PRESENT,ACTION)
			 VALUES('$id','$school', '$yr', '$sec', '$tny', '$sy', '$principal' '$au', '$lu', '$adv',  '$rank', '$tbca', '$Tdc', '$Tp','Promoted' ) ");
